...
export interface Circuit { readonly publicId: string; readonly circuitReference: string; readonly description: string; readonly media: string; readonly status: string; readonly version: number; readonly extensions: ExtensionValues; readonly segments: readonly Segment[]; }
export interface Requirement { readonly publicId: string; readonly cataloguePublicId: string | null; readonly description: string; readonly quantityRequired: number; readonly unit: string | null; readonly version: number; readonly extensions: ExtensionValues; }
export interface WorkPackage { readonly publicId: string; readonly site: { readonly publicId: string; readonly code: string; readonly name: string; }; readonly packageReference: string; readonly externalReference: string | null; readonly projectReference: string | null; readonly title: string; readonly description: string; readonly status: string; readonly leadAssignee: string | null; readonly assignees: readonly string[]; readonly version: number; readonly extensions: ExtensionValues; readonly workItems: readonly WorkItem[]; readonly circuits: readonly Circuit[]; readonly consumableRequirements: readonly Requirement[]; }
