export interface EngineerProfile { readonly assignmentName: string; readonly jobTitle: string; readonly weeklyCapacityHours: number; readonly version: number; }
export interface User { readonly publicId: string; readonly username: string; readonly displayName: string; readonly email: string | null; readonly role: 'admin' | 'manager' | 'engineer' | 'viewer'; readonly active: boolean; readonly accountStatus: 'requested' | 'approved' | 'rejected'; readonly requestedAt: string | null; readonly approvedAt: string | null; readonly profile: EngineerProfile | null; readonly version: number; }
...
export interface ConsumableCatalogueRecord { publicId: string; catalogueReference: string; description: string; estimatedUnitPrice: number | null; unit: string; active: boolean; version: number; }
export interface FibreSku { publicId: string; sku: string; description: string; itemType: string; fibreType: string; fibreMode: 'singlemode' | 'multimode'; fromConnector: string; toConnector: string; simplex: boolean; lengthMetres: number; unitPrice: number; active: boolean; version: number; }
export interface BomResult { readonly workPackage: { readonly publicId: string; readonly packageReference: string; readonly siteCode: string }; readonly fibreLines: readonly (FibreSku & { readonly quantity: number; readonly simplexCount: number; readonly lineTotal: number; readonly segmentReferences: readonly string[] })[]; readonly matches: readonly { readonly segmentPublicId: string; readonly circuitReference: string; readonly segmentReference: string; readonly requiredLengthMetres: number; readonly sku: FibreSku; readonly matchType: 'exact' | 'next-up'; readonly quantity: number; readonly simplexCount: number; readonly lineTotal: number }[]; readonly unmatched: readonly { readonly segmentPublicId: string; readonly circuitReference: string; readonly segmentReference: string; readonly requiredLengthMetres: number | null; readonly reason: string; readonly message: string }[]; readonly consumables: readonly { readonly publicId: string; readonly catalogueReference: string | null; readonly description: string; readonly quantity: number; readonly unit: string; readonly unitPrice: number | null; readonly lineTotal: number | null }[]; readonly totals: { readonly fibre: number; readonly consumables: number; readonly combined: number }; }
